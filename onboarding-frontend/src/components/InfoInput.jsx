  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid
        ...
        md={8}
        alignItems="center"
        sx={{ marginTop: "1rem", alignItems: "start" }}
      >
        <Accordion
            ...
            <Grid item xs={12} md={12}>
              ...
              >
                ...
                <Grid item xs={12} md={5}>
                  <Typography variant="h6" sx={{ color: "#11C5A7" }}>
      ...
      <Grid
        ...
        xs={12}
        md={4}
        sx={{ marginTop: "2rem", alignContent: "center" }}
      >
        <Typography sx={{ fontSize: "1rem", color: "grey" }}>
          Total Carbon Footprint
        </Typography>
        <Typography
          sx={{ fontSize: "4rem", textShadow: "2px 2px 4px lightgrey" }}
        >
          <span style={{ color: "#11C5A7" }}>{result.toFixed(2)}</span>
        </Typography>
        <Typography sx={{ fontSize: "1rem", color: "grey" }}>kg CO2</Typography>
      </Grid>
