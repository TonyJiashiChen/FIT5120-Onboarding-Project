...
export default function Intro() {
  ...
  const isScreenLargerThanMd = useMediaQuery((theme) =>
    ...
    <Container>
      <Grid container spacing={3}>
        <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
          <ScaleOnHover>
            <Paper
              className="IntroPaper"
              sx={{ backgroundColor: theme.palette.primary.dark, p: 1 }}
            >
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  overflow="hidden"
                >
                  The Carbon Visualiser allows you to compare each of your
                  activity's carbon footprint and provides call-to-action
                  suggestions specific to the top 3 carbon emitting activities.
                </Typography>
              </Box>
            </Paper>
          </ScaleOnHover>
